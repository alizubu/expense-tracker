    ...
    <div className="flex flex-col w-full h-full bg-[var(--bg-surface)] p-[16px] rounded-[16px] border border-[var(--border-hair)] transition-all duration-200">
      ...
      <div className="flex-1 overflow-auto hide-scrollbar">
        <Table 
          ...
          removeWrapper 
          classNames={{
            th: "bg-[var(--bg-raised)] text-[var(--text-muted)] border-b border-[var(--border-hair)] text-[10px] uppercase font-ui tracking-wide px-2 h-8",
            td: "px-2 py-3 border-b border-[var(--border-hair)]",
            tr: "hover:bg-[var(--bg-raised)] transition-colors cursor-pointer group",
          }}
          onRowAction={() => openModal("addTransaction")}
        >
          <TableHeader>
        ...
        {hasMore && (
          <div className="mt-4 flex justify-center pb-2">
            <Button 
              ...
              variant="flat" 
              onPress={loadMore}
              className="bg-[var(--bg-raised)] text-[var(--text-primary)] hover:bg-[var(--border-hair)]"
            >
              Load More
            </Button>
          </div>
